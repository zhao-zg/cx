...
**所有内容页面的文本段落统一使用 `.content-text` 类名**，该样式在 base.html 中定义：

- **听抄页面** (`message.html`): ✅ 使用 `.content-text`
- **晨兴页面** (`morning_revival.html`): ✅ 使用 `.content-text`
- **纲目页面** (`outline.html`): 使用 base.html 的 section 样式
- **职事页面** (`ministry.html`): ✅ 使用 `.content-text`
...
所有数据页面的内容段落使用统一的 `.content-text` 样式，定义在 base.html 中：
...
| 页面 | 内容段落类名 | 状态 |
|------|-------------|------|
| message.html | `.content-text` | ✅ 已统一 |
| morning_revival.html | `.content-text` | ✅ 已统一 |
| ministry.html | `.content-text` | ✅ 已统一 |
| outline.html | section 样式 | ✅ 使用 base.html |
| hymn.html | - | ✅ 无需统一 |
| summary.html | section 样式 | ✅ 使用 base.html |

### 7. 重构完成状态

1. ✅ 在 base.html 中定义 `.content-text` 通用样式（包括桌面端和移动端）
2. ✅ 统一 message.html 的文本样式为 `.content-text`
3. ✅ 统一 morning_revival.html 的文本样式为 `.content-text`
4. ✅ 统一 ministry.html 的文本样式为 `.content-text`
5. ✅ 移除各页面中重复的样式定义
6. ✅ 确保所有页面的行高、间距、字体大小完全一致（桌面端和移动端）
