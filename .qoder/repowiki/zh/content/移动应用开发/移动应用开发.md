...
## 更新摘要
**所做更改**
- 新增TTS性能监控和资源清理功能章节，详细介绍静态实例轮询等待机制、预合成文件清理策略和性能监控系统
- 更新NativeTTSPlugin和TTSForegroundService的架构分析，反映新增的资源清理和性能监控功能
- 增强性能监控系统的实现细节，包含合成时间、播放延迟、MediaPlayer准备时间和预热效果的跟踪
- 新增赞助二维码自动清理机制的技术实现说明
- 更新静态TTS实例轮询等待机制的详细分析，包括200ms轮询间隔和15秒超时策略
